...
Platinum 3
9248 - Suffix Array
meta: {"problemId": 9248, "titleKo": "Suffix Array", "titles": [{"language": "ko", "languageDisplayName": "ko", "title": "Suffix Array", "isOriginal": true}], "isSolvable": true, "isPartial": false, "acceptedUserCount": 1507, "level": 18, "votedUserCount": 135, "sprout": false, "givesNoRating": false, "isLevelLocked": false, "averageTries": 2.367000102996826, "official": true, "tags": [{"key": "string", "isMeta": false, "bojTagId": 158, "problemCount": 2964, "displayNames": [{"language": "ko", "name": "문자열", "short": "문자열"}, {"language": "en", "name": "string", "short": "string"}, {"language": "ja", "name": "文字列", "short": "文字列"}], "aliases": [{"alias": "스트링"}]}, {"key": "suffix_array", "isMeta": false, "bojTagId": 77, "problemCount": 133, "displayNames": [{"language": "ko", "name": "접미사 배열과 LCP 배열", "short": "접미사 배열과 LCP 배열"}, {"language": "en", "name": "suffix array and lcp array", "short": "suffix array and lcp array"}, {"language": "ja", "name": "接尾辞配列・LCP配列", "short": "接尾辞配列・LCP配列"}], "aliases": []}], "metadata": {}}
*/
