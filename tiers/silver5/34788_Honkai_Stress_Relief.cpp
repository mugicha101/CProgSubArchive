/*
Silver 5
34788 - Honkai Stress Relief
meta: {"problemId": 34788, "titleKo": "Honkai Stress Relief", "titles": [{"language": "en", "languageDisplayName": "en", "title": "Honkai Stress Relief", "isOriginal": true}], "isSolvable": true, "isPartial": false, "acceptedUserCount": 32, "level": 6, "votedUserCount": 6, "sprout": false, "givesNoRating": false, "isLevelLocked": false, "averageTries": 1.4687999486923218, "official": true, "tags": [{"key": "math", "isMeta": false, "bojTagId": 124, "problemCount": 8082, "displayNames": [{"language": "ko", "name": "수학", "short": "수학"}, {"language": "en", "name": "mathematics", "short": "math"}, {"language": "ja", "name": "数学", "short": "数学"}], "aliases": []}, {"key": "combinatorics", "isMeta": false, "bojTagId": 6, "problemCount": 1292, "displayNames": [{"language": "ko", "name": "조합론", "short": "조합론"}, {"language": "en", "name": "combinatorics", "short": "combinatorics"}, {"language": "ja", "name": "組み合わせ", "short": "組み合わせ"}], "aliases": [{"alias": "combination"}, {"alias": "permutation"}, {"alias": "probability"}, {"alias": "확률"}, {"alias": "순열"}]}, {"key": "probability", "isMeta": false, "bojTagId": 177, "problemCount": 508, "displayNames": [{"language": "ko", "name": "확률론", "short": "확률론"}, {"language": "en", "name": "probability theory", "short": "probability"}, {"language": "ja", "name": "確率論", "short": "確率論"}], "aliases": [{"alias": "expected value"}, {"alias": "기대값"}, {"alias": "기댓값"}]}], "metadata": {}}
*/
...
int main() {
    ...
    // 1 - prob that no days shes stressed = prod of overlap
    int n, a, b; cin >> n >> a >> b;
    ld res = 1.0;
    for (int i = 0; i < n; ++i) {
        int s, e; cin >> s >> e;
        ...
        ld p = (ld)(te-ts) / (ld)(b-a); // prob that not stressed
        res *= p;
    }
    cout << 1.0 - res << endl;
}
