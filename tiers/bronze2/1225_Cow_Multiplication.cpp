...
int main() {
    ...
    string a, b; cin >> a >> b;
    ll res = 0;
    for (char c : a) for (char d : b) res += (int)(c-'0') * (int)(d-'0');
    cout << res << endl;
}
