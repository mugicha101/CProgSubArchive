...
Platinum 3
1605 - 반복 부분문자열
meta: {"problemId": 1605, "titleKo": "반복 부분문자열", "titles": [{"language": "ko", "languageDisplayName": "ko", "title": "반복 부분문자열", "isOriginal": true}], "isSolvable": true, "isPartial": false, "acceptedUserCount": 1365, "level": 18, "votedUserCount": 140, "sprout": false, "givesNoRating": false, "isLevelLocked": false, "averageTries": 2.254199981689453, "official": true, "tags": [{"key": "string", "isMeta": false, "bojTagId": 158, "problemCount": 2964, "displayNames": [{"language": "ko", "name": "문자열", "short": "문자열"}, {"language": "en", "name": "string", "short": "string"}, {"language": "ja", "name": "文字列", "short": "文字列"}], "aliases": [{"alias": "스트링"}]}, {"key": "hashing", "isMeta": false, "bojTagId": 8, "problemCount": 208, "displayNames": [{"language": "ko", "name": "해싱", "short": "해싱"}, {"language": "en", "name": "hashing", "short": "hash"}, {"language": "ja", "name": "ハッシュ化", "short": "ハッシュ"}], "aliases": []}, {"key": "suffix_array", "isMeta": false, "bojTagId": 77, "problemCount": 133, "displayNames": [{"language": "ko", "name": "접미사 배열과 LCP 배열", "short": "접미사 배열과 LCP 배열"}, {"language": "en", "name": "suffix array and lcp array", "short": "suffix array and lcp array"}, {"language": "ja", "name": "接尾辞配列・LCP配列", "short": "接尾辞配列・LCP配列"}], "aliases": []}, {"key": "rabin_karp", "isMeta": false, "bojTagId": 61, "problemCount": 26, "displayNames": [{"language": "ko", "name": "라빈–카프", "short": "라빈–카프"}, {"language": "en", "name": "rabin–karp", "short": "rabin–karp"}, {"language": "ja", "name": "ラビン-カープ文字列検索", "short": "ラビン-カープ文字列検索"}], "aliases": [{"alias": "라빈카프"}]}], "metadata": {}}
*/
...
int main() {
    ...
    // longest repeating substring = max(lcp)
    // this is because lcp[i] = length of longest common prefix of alphabetically adjacent suffixes -> this common prefix appears at least twice
    int n; cin >> n;
    string s; cin >> s;
    SuffixArray sa(s);
